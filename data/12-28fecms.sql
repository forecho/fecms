...
CREATE TABLE IF NOT EXISTS `fe_excel` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='资源表' AUTO_INCREMENT=50 ;
...
CREATE TABLE IF NOT EXISTS `fe_options` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='网站的配置信息' AUTO_INCREMENT=3 ;

--
-- 转存表中的数据 `fe_options`
--

INSERT INTO `fe_options` (`id`, `option_name`, `option_value`) VALUES
(1, '公司名字', '钢铁在线'),
(2, '公司电话', '');
