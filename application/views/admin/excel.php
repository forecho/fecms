<div class="tab-content" id="tab2">
  <form action="feadmin/excelUpdate/<?php echo $excel_one->id;?>" method="post" class="registerform" onSubmit="return chkinput(this)" enctype="multipart/form-data">
	<fieldset>
	...
	<p>
		...
		<input type="file" class="text-input small-input" id="small-input" name="image" value="<?php echo $excel_one->image;?>" datatype="*"/>
		<?php if($excel_one->image != ""):?>
			<a href="uploads/img/<?php echo $excel_one->image;?>" title="查看" target="_blank">已上传图片</a>
		<?php endif;?>
		<span class="Validform_checktip"></span>
	</p>
	<p>
